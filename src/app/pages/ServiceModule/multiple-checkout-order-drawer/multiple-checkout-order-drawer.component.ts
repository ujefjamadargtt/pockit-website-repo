...
export class MultipleCheckoutOrderDrawerComponent {
  ...
  bookNow() {
    ...
    //     try {
    //       // Extract start and end times from selectedSlot
    ...
    //       // const expectedDateTime = `${formattedDate} ${formattedStartTime}`;

    //       this.MaxEndValue = this.roundTimeToInterval(this.MaxEndValue, 10); // 10-minute interval

    // const expectedDateTime = `${formattedDate} ${this.MaxEndValue}`;
    //
